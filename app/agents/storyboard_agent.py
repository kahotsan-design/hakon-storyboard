...
■ 原则3：台词必须带 speaker，逐字保留
   ...
   原文是"我……明天不在这个城市了。"——dialogue 就必须写"我……明天不在这个城市了。"。
   原文是英文 "I won't be here tomorrow."——dialogue 就必须写 "I won't be here tomorrow."。
...
==================================================
   ...
   跟随剧本原文语言：剧本是英文就用英文写，剧本是中文就用中文写。
...
class StoryboardDirectorAgent:
    ...
    def run(self, understanding: ScriptUnderstanding) -> list[SceneStoryboard]:
        ...
        user_prompt = (
            ...
            f"6. 台词语言必须与剧本原文一致，英文剧本台词保持英文，绝不翻译。"
        )
